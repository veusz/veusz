...
class ImportParamsFITS2(base.ImportParamsBase):
...
class LinkedFileFITS2(base.LinkedFileBase):
    """Links a HDF5 file to the data."""

    def createOperation(self):
        """Return operation to recreate self."""
        return OperationDataImportFITS2
...
class OperationDataImportFITS2(base.OperationDataImportBase):
    ...
    def doImport(self):
        ...
        if par.linked:
            linkedfile = LinkedFileFITS2(par)
        else:
            linkedfile = None
...
def ImportFileFITS(
    ...
    params = ImportParamsFITS2(
        ...
        renames=renames,
        linked=linked)
    op = OperationDataImportFITS2(params)
